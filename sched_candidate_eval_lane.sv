...
module sched_candidate_eval_lane (
  ...
  cand_token_t cand_lat_q, cand_lat_d;
  ...
  always_comb begin
    cand_dec = decode_token_fn(cand_lat_q, head_i, base_timeline_a_i,
  ...
  always_comb begin
    shape_ovr = decode_shape_override_fn(cand_lat_q, token_idle_is_c3);
